...
<div class="side-bar">
   ...
   <nav class="navbar">
      ...
      <a href="asmrlist.php"><i class="fa-solid fa-bars-staggered"></i><span>Asmr playlist</span></a>
      <!-- <a href="student.php"><i class="fas fa-graduation-cap"></i><span>kids performance</span></a> -->
      <a href="user_grades.php"><i class="fas fa-graduation-cap"></i><span>kids grades</span></a>
      <a href="contents.php"><i class="fas fa-graduation-cap"></i><span>contents</span></a>
      <a href="asmr.php"><i class="fas fa-graduation-cap"></i><span>Asmr Videos</span></a>
